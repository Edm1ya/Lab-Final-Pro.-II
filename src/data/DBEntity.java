...
public class DBEntity {
    ...
    public ResultSet getMeta() {
        try {
            ...
            ResultSet rlSet = dbmd.getTables(getDBCatalog(), null, "%", new String[] { "TABLE" });
    ...
    public void ShowDbObject(Scanner pin) {
        try {
            ...
            do {
                ...
                // imprime un menu con las tablas como objciones opciones
    ...
    public boolean execSQL(String sql) {
        try {
            ...
            System.out.println(ActionMessage = e.toString());
            return false;
        } catch (Exception d) {
            ActionMessage = d.toString();
            return false;
